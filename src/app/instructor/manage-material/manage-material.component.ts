...
export class ManageMaterialComponent {
  ...
  CreateCourseSection() {
    this.CreateCourseSectionForm.controls['sectionid'].setValue(this.selectedSection);

    this._instructorService.CreateCourseSection(this.CreateCourseSectionForm.value);
  }

  CreateLecture() {
    this.CreateLectureForm.controls['lecturefile'].setValue(this.filesPath);

    this._instructorService.CreateLecture(this.CreateLectureForm.value , this.selectedSection);
  }
  ...
  OpenUpdateDialog(data : any){
    ...
    UpdateCourseSection(){
      ...
      this._instructorService.UpdateCourseSection(this.UpdateCourseSectionForm.value);
    }

    UpdateLecture(){
      this.UpdateLectureForm.controls['lecturefile'].setValue(this.filesPath);

      this._instructorService.UpdateLecture(this.UpdateLectureForm.value ,  this.selectedSection);
    }
