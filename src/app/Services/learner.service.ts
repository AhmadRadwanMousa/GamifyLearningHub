...
export class LearnerService {
  ...
  UserDashboardInfoByUserId(id: number){    
    this.http.get(`${URL}/UserDashboardInfo/UserDashboardInfoByUserId/${id}`).subscribe(
      {
        next:(res)=>{
          this.spinner.show;
  ...
  UserDashboardAttendence(userid: number, sectionid: number){    
    this.http.get(`${URL}/UserDashboardInfo/UserDashboardAttendence/${userid}/${sectionid}`).subscribe(
      {
        next:(res)=>{
          this.spinner.show;
